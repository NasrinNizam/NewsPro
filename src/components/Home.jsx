        ...
        <div className=" flex gap-[30px] mb-[57px]">
          ...
          <div className=" w-[370px]">
            ...
            <div className=" flex flex-col items-center gap-[10px] border-[#E5E5E5] border-[1px] p-[10px] w-[370px] ">
              <VideoCard type="Fashion" color='text-[#E12127]' videos={<iframe width="110" height="90" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>} title="Brings big changes in people's lives." />
              <VideoCard type="Lifestyle" color="text-[#FF005C]" videos={<iframe width="110" height="90" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>} title="Brings big changes in people's lives." />
              <VideoCard type="Technology" color="text-[#10CFFA]" videos={<iframe width="110" height="90" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>} title="Brings big changes in people's lives." />
              <VideoCard type="Travel" color="text-[#5200FF]" videos={<iframe width="110" height="90" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>} title="Brings big changes in people's lives." />
            </div>
          </div>
        </div>
          ...
          <div className="div">
            ...
            <div className="flex justify-between items-center">
              <div className="w-[670px] h-[546px] ">
                <div className="w-[670px] h-[460px] "><iframe width="670" height="460" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                <div className="div">
